...
test1.buildBox( );
test1.setColorStyle( 0xffff0000 );
test1.moveTo( 10, 10 );
test1.resetCanvas( );
...
affect.duration = 20000;
affect.state += Affect.COLOR;
// affect.loop = true;
affect.addValue( 0xff000000, 0, Affect.COLOR );
affect.addValue( 0x0000ff00, 5000, Affect.COLOR );
window.rendercallbackfunc = function(e)
{
	affect.update( e );
	Global.pushAffect( affect );
